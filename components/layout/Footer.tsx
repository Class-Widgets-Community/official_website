    ...
    <footer className="bg-[#0A0B15] text-white">
      <div className="container mx-auto px-4 py-16">
          ...
          <div className="flex flex-col gap-6">
            <div className="flex items-center gap-3">
              <img
                ...
                className="h-10 w-10"
              />
              <span className="text-xl font-bold">Class Widgets Community Edition</span>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <a href="https://qm.qq.com/q/LrSAgiQvu" className="text-[#87878A] hover:text-white transition-colors">
                {/* QQ */}
              ...
              <a href="https://github.com/Class-Widgets-Community" className="text-[#87878A] hover:text-white transition-colors">
                {/* GitHub */}
        ...
        <div className="mt-16 border-t border-[#1A1B26] pt-8 text-center text-[#87878A]">
          <p>© {new Date().getFullYear()} Class Widgets Community Edition. {t("footer.cr")}</p>
        </div>
      </div>
    </footer>
  );
